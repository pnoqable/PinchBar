...
class Settings: WithUserDefaults {
    struct Defaults {
        static let preMappings = ["Fix Logi Flags":     PreMapping.fixLogiFlags,
                                  "Logi Mouse Zoom":    PreMapping.logiMouseZoom,
    ...
    init() {
        ...
        preMappings.merge(Defaults.preMappings, uniquingKeysWith: returnFirst)
        presets.merge(Defaults.presets, uniquingKeysWith: returnFirst)
        appPresets.merge(Defaults.appPresets, uniquingKeysWith: returnFirst)
